...
<?php
	...
	$sql=mysqli_query($conn,"select * from user where email='$txtEMail'");
	...
	$r=mysqli_num_rows($sql);
		...
		$query="insert into user values('','$txtName','$branch','$sem','$txtEMail','$txtPassword','$txtMobNo','$gender','$imageName','$dob',now(),'pending')";
...
<body>
    ...
    <div class="inner-banner">
        <section class="w3l-breadcrumb">
            <div class="container">
                <h4 class="inner-text-title font-weight-bold text-white mb-sm-3 mb-2">Student Registration</h4>
                <ul class="breadcrumbs-custom-path">
                    <li><a href="index.html">Home</a></li>
                    <li class="active"><span class="fa fa-chevron-right mx-2" aria-hidden="true"></span> Register Student</li>
                </ul>
            </div>
        </section>
    </div>
            ...
            <div class="mx-auto" style="max-width:1000px">
                ...
                <div class="contact-form-sec pt-5 mt-md-5">
					...
					<h2 class="title-main"><?php echo @$err;?></h3>
                        <h3 class="title-main">Registeration for <span>Student</span></h3>
                    </div>
                    <div class="row contact-block align-items-center">
                        <div class="col-md-5 contact-left">
                            <img src="assets/images/image.png" alt="" class="img-fluid img-responsive">
                        </div>
                        <div class="col-md-7 contact-right mt-md-0 mt-4 pl-lg-4">
                            <form method="post" class="signin-form" enctype="multipart/form-data">
                                <div class="input-grids">
									...
									<label class="contact-input" for="branch">Choose a Branch:</label>
										<select id="branch" name="branch" style="width:100px; left-margin=20px;">
										  <option value="BCA">BCA</option>
										  <option value="MCA">MCA</option>
										</select>
										
									<label class="contact-input" for="sem">Semester:</label>
									...
									<label for="gender">Choose Gender:</label>
										<select id="gender" name="gender" style="width:100px; left-margin=20px;">
										  <option value="Male">Male</option>
										  <option value="Female">Female</option>
										</select>
										
                                    <br><label for="branch">Select Your Date of Birth:</label>
									<input type="date" id="dob" name="dob" class="contact-input"/>
                                    <br><label for="branch">Select Your Image:</label>
