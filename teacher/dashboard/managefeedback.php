		...
		<div class="col_1">
			<div class="col-md-4 span_8">
				<div class="activity_box">
					<h2>BCA STUDENTS FEEDBACKS</h2>

					<div class="scrollbar" id="style-1">

					<?php
						$que=mysqli_query($conn,"select * from stud_feedback where branch='BCA'");
						while($row=mysqli_fetch_array($que))
						{
						?>
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='../../images/admin.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
								<h5><a href="#"><?php echo $row[0].' . '.$row[1] ?></a></h5>
								<p><?php echo $row[2] ?></p>
								<p><?php echo $row[3] ?></p>
								<p><?php echo $row[4] ?></p>
							</div>
							<div class="col-xs-2 activity-desc1"><h6><p><font color=red ><?php echo strtoupper($row[5]) ?></font></p></h6></div>
							<div class="clearfix"> </div>
						</div>
					<?php
						}
			...
			<div class="col-md-4 span_8">
				<div class="activity_box activity_box2">
					<h3>MCA STUDENTS FEEDBACK</h3>

					<div class="scrollbar" id="style-2">

					<?php
						$que=mysqli_query($conn,"select * from stud_feedback where branch='MCA'");
						while($row=mysqli_fetch_array($que))
						{
						?>
						<div class="activity-row">
