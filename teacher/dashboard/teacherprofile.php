...
{
		$sql=mysqli_query($conn,"select * from teacher where email='$admin'");
		...
		if(isset($save))
		{
			...
			$sql=mysqli_query($conn,"update teacher set name='$name',mobno='$mobno' where email='$admin'");
					...
					<form method="post">
						<div class="stats">
							...
							<div class="col-sm-4"><?php echo @$err;?></div>
								...
								<img class="img-responsive" width="120" src="../../images/<?php echo $admin ?>/<?php echo $pic; ?>" alt="Photo">
						</div>


						<div class="form-group">
								<label for="user_title">User Name</label>
								<input type="text" name="username" class="form-control" value="<?php echo $r[3] ?>" readonly class="stats">
						</div>

						<div class="form-group">
							<label for="user_author">Name</label>
							<input type="text" name="name" class="form-control"  value="<?php echo $r[1] ?>" required>
						</div>

						<div class="form-group">
							<label for="user_tag">Phone No.</label>
							<input type="text" name="mobno" class="form-control"  value="<?php echo $r[2] ?>" required>
						</div>
