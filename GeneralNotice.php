...
<body>
    ...
    <div class="inner-banner">
        <section class="w3l-breadcrumb">
            <div class="container">
                <h4 class="inner-text-title font-weight-bold text-white mb-sm-3 mb-2">Notices</h4>
                <ul class="breadcrumbs-custom-path">
                    <li><a href="index.html">Home</a></li>
                    <li class="active"><span class="fa fa-chevron-right mx-2" aria-hidden="true"></span> General Notices</li>
                </ul>
            </div>
        </section>
    </div>
            ...
            <div class="mx-auto" style="max-width:1000px">
                ...
                <div class="contact-form-sec pt-5 mt-md-5">
					...
					<h2 class="title-main"><?php echo @$err;?></h3>
                        <h3 class="title-main">General <span>Notices</span></h3>
                    </div>
                    <div class="row contact-block align-items-center">
                        <div class="col-md-5 contact-left">
                            <img src="assets/images/notice_img1.jpg" alt="" class="img-fluid img-responsive">
                        </div>
                        
						<script  src="js/index1.js"></script>
					
			<div class="col-md-4 span_8" width=400px>
				<div class="activity_box activity_box2" width=400px>
					<h3>ALL NOTICES</h3>

					<div class="scrollbar" id="style-2" width=400px>
					...
					<?php
						...
						<div class="activity-row" >
							...
							<div class="col-xs-2 activity-desc1"><h6><p><a href="admin/dashboard/notice/<?php echo $row[6] ?>" style='color:Red'><font color=red >View</font></a></p></h6></div>
