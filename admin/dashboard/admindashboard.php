            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
				...
				<ul class="treeview-menu">
                  ...
                  <li><a href="viewnotice.php"><i class="fa fa-angle-right"></i> View All Notification</a></li>
                </ul>
              </li>
              <li class="treeview">
				...
				<div class="activity_box">
					...
					<?php
						...
						<div class="activity-row">
							...
							<div class="col-xs-2 activity-desc1"><h6><p><a href="javascript:UpdateTStatus('<?php echo$row[3] ?>')" style='color:Red'><font color=red ><?php echo strtoupper($row[8]) ?></font></a></p></h6></div>
							<div class="clearfix"> </div>
						</div>
					<?php
						}
				...
				<div class="activity_box activity_box2">
					...
					<div class="scrollbar" id="style-2">
						...
						<div class="activity-row">
							...
							<div class="col-xs-2 activity-desc1"><h6><p><a href="javascript:UpdateSStatus('<?php echo$row[4] ?>')" style='color:Red'><font color=red ><?php echo strtoupper($row[11]) ?></font></a></p></h6></div>
