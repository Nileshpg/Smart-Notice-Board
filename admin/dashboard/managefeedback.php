				...
				<div class="activity_box">
					...
					<?php
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='../../images/<?php echo $row[2] ?>/<?php echo $row[6] ?>' class="img-responsive" alt=""/></div>
				...
				<div class="activity_box activity_box1">
					...
					$que=mysqli_query($conn,"select * from feedback");
						...
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src='../../images/user.png' class="img-responsive" alt=""/><span><?php echo $row[5] ?></span></div>
