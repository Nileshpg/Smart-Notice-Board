		...
		<div class="col_1">
			<div class="col-md-4 span_8">
				<div class="activity_box">
					<h2>BCA TEACHERS NOTICES</h2>

					<div class="scrollbar" id="style-1">

					<?php
						$que=mysqli_query($conn,"select * from teacher_notice where Branch='BCA'");
						while($row=mysqli_fetch_array($que))
						{
						?>
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='../../images/<?php echo $row[1] ?>/<?php echo $row[10] ?>' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
								<h5><a href="#"><?php echo $row[1] ?></a></h5>
								<p><?php echo $row[2] ?></p>
								<p><?php echo $row[3] .'   '. $row[4].' Sem'; ?></p>
								<p><?php echo $row[5] ?></p>
								<p><?php echo $row[6] ?></p>
							</div>
							<div class="col-xs-2 activity-desc1"><h6><p><font color=red ><?php echo $row[9] ?></font></p></h6></div>
							<div class="col-xs-2 activity-desc1"><h6><p><a href="../../teacher/dashboard/notice/<?php echo $row[8] ?>" style='color:Red'><font color=red >View</font></a></p></h6></div>
							<div class="col-xs-2 activity-desc1"><h6><p><font color=red ><?php echo $row[7] ?></font></a></p></h6></div>
			...
			<div class="col-md-4 span_8">
				<div class="activity_box activity_box2">
					<h3>MCA TEACHERS NOTICES</h3>

					<div class="scrollbar" id="style-2">

					<?php
						$que=mysqli_query($conn,"select * from teacher_notice where Branch='MCA'");
						while($row=mysqli_fetch_array($que))
						{
						?>
						<div class="activity-row">
