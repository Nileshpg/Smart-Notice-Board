...
else
{
		...
		if(isset($save))
		{
			...
			{
				$sql=mysqli_query($conn,"insert into stud_feedback values('','$name','$admin','$subject','$desc',now(),'$pic','$branch')");
				$err="<font color='blue'>Feedback Submitted Successfully </font>";
			}
		}
?>
		...
		<div class="col_1">
				...
				<div class="activity_box">
					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-sm-5">
							<input type="text" name="subject" class="form-control" required style="width:200px; left-margin=20px;"/></div>
						</div>

						<div class="row">
							<div class="col-sm-4">Description</div>
							<div class="col-sm-5">
							<input type="text" name="desc" class="form-control" required style="width:200px; left-margin=20px;"/></div>
						</div>
			...
			<div class="col-md-4 span_8">
				<div class="activity_box activity_box2">
					<h3>ALL FEEDBACKS from <?php echo $branch ?> Branch</h3>
