		...
		<div class="col_1" >
			<!--<div class="col-md-4 span_8" >
				<div class="activity_box">
					...
					<?php
						$que=mysqli_query($conn,"select * from teacher where branch='$branch'");
			...
			<div class="col-md-4 span_8">
				<div class="activity_box activity_box1">
					<h3>FEEDBACKS from <?php $branch; ?> Branch</h3>
					<div class="scrollbar" id="style-3">
					<?php
					$que=mysqli_query($conn,"select * from stud_feedback where branch='$branch'");
						while($row=mysqli_fetch_array($que))
						{
						?>
