		...
		<div class="col_1">
			<div class="col-md-4 span_8">
				<div class="activity_box">
					...
					<?php
						$que=mysqli_query($conn,"select * from user where branch='BCA'");
						...
						<div class="activity-row">
							...
							<div class="col-xs-2 activity-desc1"><h6><p><a href="javascript:UpdateStatus('<?php echo$row[4] ?>')" style='color:Red'><font color=red ><?php echo strtoupper($row[11]) ?></font></a></p></h6></div>
							<div class="col-xs-2 activity-desc1"><h6><p><a href="javascript:DeleteStudent('<?php echo$row[4] ?>')" style='color:Red'><font color=red >DELETE</font></a></p></h6></div>
							<div class="clearfix"> </div>
						</div>
					<?php
						}
			...
			<div class="col-md-4 span_8">
				<div class="activity_box activity_box2">
					...
					<?php
						$que=mysqli_query($conn,"select * from user where branch='MCA'");
						while($row=mysqli_fetch_array($que))
						{
						?>
						<div class="activity-row">
