...
{
		$sql=mysqli_query($conn,"select * from user where email='$admin'");
		...
		if(isset($save))
		{
			...
			$sql=mysqli_query($conn,"update user set name='$name',mobile='$mobno' where email='$admin'");
				...
				<div class="activity_box">
					...
					<form method="post">
						...
						<div class="form-group">
								...
								<input type="text" name="username" class="form-control" value="<?php echo $r[4] ?>" readonly class="stats">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="mobno" class="form-control"  value="<?php echo $r[6] ?>" required>
						</div>
